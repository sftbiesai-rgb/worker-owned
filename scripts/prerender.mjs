...
const routes = [
  {
    ...
    description: 'Browse worker owned online stores by category or search 70,000+ products from cooperatives and employee-owned companies.',
  ...
  { url: '/marketplace/coffee-tea/directory', title: 'Coffee & Tea Companies — Worker Owned Directory', description: 'Browse all worker and employee owned coffee and tea companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/marketplace/coffee-tea/directory' },
  { url: '/marketplace/media-publishing/directory', title: 'Media & Publishing Companies — Worker Owned Directory', description: 'Browse all worker and employee owned media and publishing companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/marketplace/media-publishing/directory' },
  { url: '/marketplace/food-pantry/directory', title: 'Food & Pantry Companies — Worker Owned Directory', description: 'Browse all worker and employee owned food and pantry companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/marketplace/food-pantry/directory' },
  { url: '/marketplace/apparel/directory', title: 'Apparel Companies — Worker Owned Directory', description: 'Browse all worker and employee owned clothing and apparel companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/marketplace/apparel/directory' },
  { url: '/marketplace/art-prints/directory', title: 'Art & Prints Companies — Worker Owned Directory', description: 'Browse all worker and employee owned art and print companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/marketplace/art-prints/directory' },
  { url: '/marketplace/books/directory', title: 'Book Companies — Worker Owned Directory', description: 'Browse all worker and employee owned bookstores and publishers. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/marketplace/books/directory' },
  { url: '/marketplace/movies-tv/directory', title: 'Movies & TV Companies — Worker Owned Directory', description: 'Browse all worker and employee owned movie and TV companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/marketplace/movies-tv/directory' },
  { url: '/marketplace/music/directory', title: 'Music Companies — Worker Owned Directory', description: 'Browse all worker and employee owned music companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/marketplace/music/directory' },
  { url: '/marketplace/home-goods/directory', title: 'Home Goods Companies — Worker Owned Directory', description: 'Browse all worker and employee owned home goods companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/marketplace/home-goods/directory' },
  { url: '/marketplace/personal-care/directory', title: 'Personal Care Companies — Worker Owned Directory', description: 'Browse all worker and employee owned personal care companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/marketplace/personal-care/directory' },
  { url: '/marketplace/games/directory', title: 'Games Companies — Worker Owned Directory', description: 'Browse all worker and employee owned game companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/marketplace/games/directory' },
  { url: '/marketplace/beer-brewing/directory', title: 'Beer & Brewing Companies — Worker Owned Directory', description: 'Browse all worker and employee owned breweries. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/marketplace/beer-brewing/directory' },
  { url: '/marketplace/tech-software/directory', title: 'Tech & Software Companies — Worker Owned Directory', description: 'Browse all worker and employee owned tech and software companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/marketplace/tech-software/directory' },
  { url: '/marketplace/sporting-goods/directory', title: 'Sporting Goods Companies — Worker Owned Directory', description: 'Browse all worker and employee owned sporting goods companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/marketplace/sporting-goods/directory' },
  {
