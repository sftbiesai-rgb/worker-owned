...
const routes = [
  {
    ...
    description: 'Browse worker owned online stores by category or search 50,000+ products from cooperatives and employee-owned companies.',
  ...
  },
  {
    ...
    canonical: 'https://www.workerowned.info/companies',
  ...
  },
  {
    ...
    canonical: 'https://www.workerowned.info/coffee-tea',
  },
  {
    url: '/media-publishing',
    ...
    canonical: 'https://www.workerowned.info/media-publishing',
  },
  {
    url: '/food-pantry',
    ...
    canonical: 'https://www.workerowned.info/food-pantry',
  },
  {
    url: '/apparel',
    ...
    canonical: 'https://www.workerowned.info/apparel',
  },
  {
    url: '/art-prints',
    ...
    canonical: 'https://www.workerowned.info/art-prints',
  },
  {
    url: '/music',
    ...
    canonical: 'https://www.workerowned.info/music',
  },
  {
    url: '/home-goods',
    ...
    canonical: 'https://www.workerowned.info/home-goods',
  },
  {
    url: '/personal-care',
    ...
    canonical: 'https://www.workerowned.info/personal-care',
  },
  {
    url: '/games',
    ...
    canonical: 'https://www.workerowned.info/games',
  },
  {
    url: '/beer-brewing',
    ...
    canonical: 'https://www.workerowned.info/beer-brewing',
  },
  {
    url: '/books',
    ...
    canonical: 'https://www.workerowned.info/books',
  ...
  },
  {
    ...
    canonical: 'https://www.workerowned.info/movies-tv',
  ...
  },
  {
    ...
    canonical: 'https://www.workerowned.info/sporting-goods',
  ...
  },
  {
    ...
    canonical: 'https://www.workerowned.info/tech-software',
  ...
  { url: '/coffee-tea/directory', title: 'Coffee & Tea Companies — Worker Owned Directory', description: 'Browse all worker and employee owned coffee and tea companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/coffee-tea/directory' },
  { url: '/media-publishing/directory', title: 'Media & Publishing Companies — Worker Owned Directory', description: 'Browse all worker and employee owned media and publishing companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/media-publishing/directory' },
  { url: '/food-pantry/directory', title: 'Food & Pantry Companies — Worker Owned Directory', description: 'Browse all worker and employee owned food and pantry companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/food-pantry/directory' },
  { url: '/apparel/directory', title: 'Apparel Companies — Worker Owned Directory', description: 'Browse all worker and employee owned clothing and apparel companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/apparel/directory' },
  { url: '/art-prints/directory', title: 'Art & Prints Companies — Worker Owned Directory', description: 'Browse all worker and employee owned art and print companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/art-prints/directory' },
  { url: '/books/directory', title: 'Book Companies — Worker Owned Directory', description: 'Browse all worker and employee owned bookstores and publishers. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/books/directory' },
  { url: '/movies-tv/directory', title: 'Movies & TV Companies — Worker Owned Directory', description: 'Browse all worker and employee owned movie and TV companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/movies-tv/directory' },
  { url: '/music/directory', title: 'Music Companies — Worker Owned Directory', description: 'Browse all worker and employee owned music companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/music/directory' },
  { url: '/home-goods/directory', title: 'Home Goods Companies — Worker Owned Directory', description: 'Browse all worker and employee owned home goods companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/home-goods/directory' },
  { url: '/personal-care/directory', title: 'Personal Care Companies — Worker Owned Directory', description: 'Browse all worker and employee owned personal care companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/personal-care/directory' },
  { url: '/games/directory', title: 'Games Companies — Worker Owned Directory', description: 'Browse all worker and employee owned game companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/games/directory' },
  { url: '/beer-brewing/directory', title: 'Beer & Brewing Companies — Worker Owned Directory', description: 'Browse all worker and employee owned breweries. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/beer-brewing/directory' },
  { url: '/tech-software/directory', title: 'Tech & Software Companies — Worker Owned Directory', description: 'Browse all worker and employee owned tech and software companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/tech-software/directory' },
  { url: '/sporting-goods/directory', title: 'Sporting Goods Companies — Worker Owned Directory', description: 'Browse all worker and employee owned sporting goods companies. Directory of cooperatives and employee-owned businesses.', canonical: 'https://www.workerowned.info/sporting-goods/directory' },
  {
...
const subcategoryRoutes = [
  ...
  canonical: `https://www.workerowned.info/${s.cat}/${s.sub}`,
}))
