...
const SEARCH_TERMS = [
  ...
  // ── Music: popular album titles (catch items not in genre browse) ──
  'abbey road', 'dark side of the moon', 'thriller', 'rumours', 'nevermind',
  'ok computer', 'kid a', 'hail to the thief', 'in rainbows', 'the bends',
  'blue album weezer', 'pinkerton', 'is this it strokes', 'funeral arcade fire',
  'loveless my bloody valentine', 'remain in light', 'speaking in tongues',
  'purple rain', 'sign o the times', 'born to run', 'darkness edge of town',
  'blue train coltrane', 'kind of blue', 'bitches brew', 'a love supreme',
  'blonde on blonde', 'highway 61', 'blood on the tracks',
  'pet sounds', 'sgt peppers', 'white album', 'let it be', 'revolver',
  'exile on main', 'sticky fingers', 'let it bleed',
  'wish you were here', 'the wall pink floyd', 'animals pink floyd',
  'ziggy stardust', 'heroes bowie', 'low bowie', 'hunky dory',
  'grace jeff buckley', 'either or elliott smith', 'pink moon nick drake',
  'songs of leonard cohen', 'blue joni mitchell', 'court and spark',
  'harvest neil young', 'after the gold rush', 'rust never sleeps',
  'appetite for destruction', 'use your illusion', 'back in black', 'highway to hell',
  'master of puppets', 'ride the lightning', 'number of the beast',
  'paranoid black sabbath', 'led zeppelin iv', 'houses of the holy', 'physical graffiti',
  'the chronic', 'illmatic', 'ready to die', 'enter the wu tang',
  'aquemini outkast', 'midnight marauders', 'the miseducation', 'lauryn hill',
  'good kid maad city', 'to pimp a butterfly', 'damn kendrick',
  'channel orange', 'blonde frank ocean', 'igor tyler creator', 'flower boy',
  'melodrama lorde', 'pure heroine', 'lemonade beyonce',
  'folklore taylor swift', 'midnights taylor swift', '1989 taylor swift',
  'currents tame impala', 'lonerism', 'innerspeaker',
  'for emma bon iver', 'carrie and lowell', 'illinois sufjan',
  'in the aeroplane', 'yankee hotel foxtrot', 'selected ambient works',
  'homogenic bjork', 'vespertine', 'post bjork',
  'the suburbs arcade fire', 'the age of adz', 'fetch the bolt cutters',
  'punisher phoebe bridgers', 'stranger in the alps',
  'lifting off vince staples', 'mm food', 'madvillainy',
  'undun roots', 'things fall apart', 'black on both sides',
  'stankonia', 'speakerboxxx', 'love below',

  // ── Music: more genres & formats ──
  'jazz vinyl', 'classical vinyl', 'soul vinyl', 'r&b vinyl', 'folk vinyl',
  'country vinyl', 'reggae vinyl', 'punk vinyl', 'hip hop vinyl',
  'soundtrack vinyl', 'musical vinyl', 'opera vinyl',
  'box set', 'deluxe edition', 'remaster', 'anniversary edition', 'colored vinyl',
  'live album', 'greatest hits vinyl', 'compilation vinyl',

  // ── Movies & TV: popular titles (catch items not in genre browse) ──
  'godfather', 'goodfellas', 'shawshank redemption', 'fight club', 'pulp fiction',
  'back to the future', 'forrest gump', 'matrix', 'inception', 'interstellar',
  'silence of the lambs', 'se7en', 'the shining', 'psycho hitchcock',
  'casablanca', 'citizen kane', 'gone with the wind', 'wizard of oz',
  'schindlers list', 'saving private ryan', 'apocalypse now', 'full metal jacket',
  'taxi driver', 'raging bull', 'the departed', 'wolf of wall street',
  'jaws', 'raiders lost ark', 'die hard', 'rocky', 'gladiator',
  'lion king', 'beauty and the beast disney', 'aladdin', 'little mermaid',
  'toy story', 'finding nemo', 'incredibles', 'up pixar', 'inside out',
  'spirited away', 'princess mononoke', 'howls moving castle', 'totoro',
  'akira', 'ghost in the shell', 'cowboy bebop', 'evangelion',
  'barbie movie', 'poor things', 'zone of interest', 'anatomy of a fall',
  'past lives', 'killers flower moon', 'saltburn', 'priscilla coppola',
  'the holdovers', 'american fiction', 'may december',
  'sopranos complete', 'breaking bad complete', 'the wire complete',
  'game of thrones complete', 'band of brothers', 'chernobyl hbo',
  'the office complete', 'parks recreation complete', 'arrested development',
  'curb your enthusiasm', 'frasier', 'cheers complete',
  'x files complete', 'twilight zone', 'black mirror',
  'downton abbey', 'the crown', 'bridgerton', 'outlander',
  'criterion collection', 'arrow video', 'shout factory', 'vinegar syndrome',
  'steelbook', '4k ultra hd', 'blu ray collection',

  // ── Video Games: more titles (catch items not in platform browse) ──
  'breath of the wild', 'tears of the kingdom', 'ocarina of time',
  'majoras mask', 'wind waker', 'twilight princess', 'link to the past',
  'super mario odyssey', 'mario kart', 'mario party', 'paper mario',
  'pokemon scarlet', 'pokemon violet', 'pokemon legends', 'pokemon sword',
  'final fantasy vii', 'final fantasy xvi', 'final fantasy remake',
  'resident evil 4', 'resident evil village', 'silent hill',
  'last of us part', 'uncharted', 'ghost of tsushima', 'bloodborne',
  'sekiro', 'armored core', 'demons souls', 'dark souls remastered',
  'cyberpunk 2077', 'witcher 3', 'red dead redemption', 'gta v',
  'starfield', 'fallout 4', 'skyrim', 'elder scrolls',
  'mass effect', 'dragon age', 'diablo', 'world of warcraft',
  'street fighter', 'mortal kombat', 'tekken',
  'stardew valley', 'celeste', 'undertale', 'shovel knight',
  'bayonetta', 'xenoblade', 'astro bot', 'stellar blade',
  'death stranding', 'metal gear solid', 'silent hill 2',
  'mario strikers', 'mario golf', 'mario tennis',
  'fifa 24', 'madden 24', 'nba 2k24', 'mlb the show',
  'nintendo switch oled', 'switch 2', 'playstation 5', 'xbox series x',
  'gaming headset', 'pro controller', 'gaming chair',

  // ── Books: more popular titles & authors ──
  'dune herbert', 'foundation asimov', 'neuromancer', 'left hand of darkness',
  'hitchhikers guide galaxy', 'enders game', 'fahrenheit 451', 'brave new world',
  '1984 orwell', 'handmaids tale', 'slaughterhouse five', 'cats cradle',
  'beloved toni morrison', 'invisible man ellison', 'their eyes were watching god',
  'great gatsby', 'to kill a mockingbird', 'catcher in the rye', 'on the road kerouac',
  'one hundred years solitude', 'love in the time of cholera', 'house of spirits',
  'kafka metamorphosis', 'crime and punishment', 'brothers karamazov',
  'war and peace', 'anna karenina', 'madame bovary', 'pride and prejudice',
  'jane eyre', 'wuthering heights', 'frankenstein', 'dracula',
  'count of monte cristo', 'les miserables', 'don quixote',
  'wind up bird chronicle', 'norwegian wood', 'kafka on the shore',
  'never let me go', 'remains of the day', 'klara and the sun',
  'life of pi', 'kite runner', 'name of the wind', 'kingkiller chronicle',
  'mistborn sanderson', 'way of kings', 'wheel of time', 'first law abercrombie',
  'cradle dungeon', 'red rising', 'expanse corey', 'three body problem',
  'gone girl flynn', 'girl on the train', 'silent patient',
  'mexican gothic', 'house of leaves', 'piranesi clarke',
  'terry pratchett', 'discworld', 'good omens', 'hitchhikers guide',
  'ursula le guin', 'earthsea', 'octavia butler', 'kindred', 'parable sower',
  'vonnegut', 'breakfast of champions', 'sirens of titan',

  // ── Books: kids picture books & early readers ──
  'goodnight moon', 'very hungry caterpillar', 'where wild things are',
  'green eggs and ham', 'cat in the hat', 'oh the places', 'lorax',
  'elephant piggie', 'llama llama', 'pete the cat', 'corduroy',
  'curious george', 'clifford big red dog', 'berenstain bears',
  'junie b jones', 'ramona quimby', 'charlotte web', 'matilda roald dahl',
  'charlie chocolate factory', 'james giant peach', 'bfg dahl',
  'chronicles narnia', 'wrinkle in time', 'phantom tollbooth',
  'bridge terabithia', 'holes louis sachar', 'because of winn dixie',
  'number the stars', 'island of the blue dolphins',

  // ── Books: cookbooks & lifestyle ──
  'joy of cooking', 'mastering art french cooking', 'food lab',
  'flavor bible', 'smitten kitchen', 'half baked harvest',
  'whole30', 'plant based cookbook', 'bread baking', 'sourdough',
  'marie kondo', 'declutter', 'minimalism',

  // ── Bull Moose merch & misc ──
  'bull moose', 'gift card', 'vinyl accessories', 'record player',
  'turntable', 'vinyl storage', 'record cleaning', 'slipmat',
  'headphones', 'speaker', 'cassette player', 'blank cassette',
  'sticker', 'enamel pin', 'patch', 'magnet', 'keychain',
  'calendar 2026', 'planner', 'journal', 'notebook',
  'tarot deck', 'oracle deck', 'crystals', 'incense',
  'candle', 'essential oil', 'bath bomb',
]
